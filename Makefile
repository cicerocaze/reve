# This Makefile is for the ReVe extension to perl.
#
...
#     NAME => q[ReVe]
#     PL_FILES => {  }
#     PREREQ_PM => { Dancer2=>q[0.142], Test::More=>q[0], YAML=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/ReVe.pm]
#     clean => { FILES=>q[ReVe-*] }
...
PERL_ARCHLIBDEP = C:\Dwimperl\perl\lib
LIBPERL_A = libperl.a
...
PERL_INCDEP = C:\Dwimperl\perl\lib\CORE
...
MAKEMAKER   = C:/Dwimperl/perl/site/lib/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.24
MM_REVISION = 72400
...
PERL_ARCHIVEDEP    = $(PERL_INCDEP)\libperl514.a
PERL_ARCHIVE_AFTER = 


TO_INST_PM = lib/ReVe.pm
...
ReVe.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"ReVe\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name: ReVe" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Dancer2: '0.142'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"ReVe\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {{" >> META_new.json
	$(NOECHO) $(ECHO) "            \"Dancer2\" : \"0.142\"," >> META_new.json
...
MAP_TARGET    = perl
FULLPERL      = "C:\Dwimperl\perl\bin\perl.exe"
MAP_PERLINC   = "-Iblib\arch" "-Iblib\lib" "-IC:\Dwimperl\perl\lib" "-IC:\Dwimperl\perl\lib"
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"ReVe\" VERSION=\"0.1\">" > ReVe.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>YOUR APPLICATION ABSTRACT</ABSTRACT>" >> ReVe.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>YOUR NAME &lt;youremail@example.com&gt;</AUTHOR>" >> ReVe.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> ReVe.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Dancer2::\" VERSION=\"0.142\" />" >> ReVe.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Test::More\" />" >> ReVe.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"YAML::\" />" >> ReVe.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x86-multi-thread-5.14\" />" >> ReVe.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> ReVe.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> ReVe.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> ReVe.ppd
